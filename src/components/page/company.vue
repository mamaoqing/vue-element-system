    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="tel" label="电话" align="center" min-width="75" min-height="55"></el-table-column>
                ...
                <el-table-column prop="createdAt" label="创建时间" align="center" min-width="125" min-height="55"></el-table-column>
                <el-table-column prop="modifiedName" label="修改人" align="center" min-width="75" min-height="55"></el-table-column>
                <el-table-column prop="modifiedAt" label="修改时间" align="center" min-width="125" min-height="55"></el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="editVisible" width="30%" >
            <el-form ref="form" :model="form" label-width="70px" :disabled="disable">
                    ...
                    { required: true, message: '请输入公司地址', trigger: 'blur' },
                        ...
                        <el-cascader
                            ...
                            children: 'childList'
                                ...
                                @change="handleChange"
                        ></el-cascader>
                        <el-input v-model="form.compAddr" prop="compAddr" placeholder="请输入详细公司地址"
                                  :rules="[
                    { required: true, message: '请输入公司地址', trigger: 'blur' },
                ]"></el-input>
                    </el-form-item>
                ...
                <div>
                    ...
                    <el-form-item label="录入时间" prop="establishmentDate" disabled>
                        <el-date-picker
                    ...
                    <el-form-item label="修改时间" prop="establishmentDate" disabled>
                        <el-date-picker
