...
<!--                <el-input v-model="query.name" placeholder="用户名" class="handle-input mr10"></el-input>-->
            ...
            >
                ...
                <el-table-column prop="abbreviation" label="公司简称"></el-table-column>
                <el-table-column prop="establishmentDate" label="成立日期"></el-table-column>
                <el-table-column prop="compAddr" label="公司地址"></el-table-column>
                <el-table-column prop="unifiedSocialCreditCode" label="统一社会信用代码"></el-table-column>

                <el-table-column prop="compType" label="公司类型"></el-table-column>
...
<script>
import { fetchData,updateData,deleteData,addData } from '../../api/index';
