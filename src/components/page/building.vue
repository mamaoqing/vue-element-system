...
import { insertBuilding,deleteBuilding,updateBuilding,listBuilding,getUserComm,getCommArea,getCommAreaContent,getDictItemByDictId,listBuildingNum,checkBuildingRoomUnit } from '../../api/building';
